...
Elaborate description spanning multiple lines, covering functoinality in more
...
def __private_function_example():
    '''
    This is a private function example, which is indicated by the leading under
    scores.
    :return: tmp_bool
    '''
    tmp_bool = True
